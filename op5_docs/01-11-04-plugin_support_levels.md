...
!Bug Support button, canary yellow background
...
!Best Effort button, orange background
...
!Deprecated button, red background
...
!Unsupported button, medium gray background
