...
Arrow 1 points to the **Action Icons**. From left to right, the **Action Icons** have the following functions:

- Print the report.
- Download the report as a CSV file.
- Download the report as a PDF file.
- Save the report in OP5 Monitor for later viewing.
- Edit the report settings.
- Direct link to report.

Arrow 2 points to the report graph. The graph shows the report data in a visual format.

Arrow 3 points to the table report table. The report table shows the report data in table form.

Arrow number 4 points to the group member area. This area shows all of the objects included in the report, and by clicking on the name of an object, an SLA report will be displayed for the object.
...
6. Set the desired values in the following options or go directly to step 7 and leave the settings with their default value.
    ...
    1.  Choose if you like to count scheduled downtime as uptime. 

        ![](images/16482315/16679186.png) \
    ...
    9.  It is possible to include a Summary Report with the SLA report. For more information about summare reports, see Alert summary - Top alert producers.
...
Arrow number 1 in the screenshot points to the report graph. 

The arrow labels number 2 in the screenshot points to the the action icons. They have the following functions from left to right:

- Print the report.
- Save the report in the CSV format.
- Show the report as a PDF.
- Save report.
- Edit settings.
- Direct link to the report.

Arrow number 3 points to a pie chart displaying the results in a graphical format.
...
Weekly reports are sent out on Monday and monthly reports are sent out on the 1st of the month.
