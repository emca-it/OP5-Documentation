...
-   [Howto: Create a event handler with Python](Howto_Create_a_event_handler_with_Python)
-   [HOWTOs](HOWTOs) ![](images/icons/contenttypes/home_page_16.png)
    -   [4 steps to turn on simple BSM in your system](4_steps_to_turn_on_simple_BSM_in_your_system)

    -   [Active Directory Integration How-To](Active_Directory_Integration_How-To)
    ...
    -   [Agentless Monitoring of Windows using WMI](Agentless_Monitoring_of_Windows_using_WMI)

    -   [Biztalk monitoring mini how-to](Biztalk_monitoring_mini_how-to)

    -   [check\_oracle with Oracle Instant Client](check_oracle_with_Oracle_Instant_Client)

    -   [Certificate management for LDAP SSL (sldap) with Active Directory](Certificate_management_for_LDAP_SSL_sldap_with_Active_Directory)

    -   [Configuring NagVis automap for large environments](Configuring_NagVis_automap_for_large_environments)
    ...
    -   [Execute PowerShell scripts](Execute_PowerShell_scripts)

    -   [Exposing Monitor's API through a reverse proxy](Exposing_Monitor_s_API_through_a_reverse_proxy)

    -   [Fetching CSV reports over HTTP](Fetching_CSV_reports_over_HTTP)
    ...
    -   [How to get started with log monitoring](How_to_get_started_with_log_monitoring)

    -   [How to get started with Nagvis video tutorial](How_to_get_started_with_Nagvis_video_tutorial)

    -   [How to Install VMware vSphere SDK for Perl](How_to_Install_VMware_vSphere_SDK_for_Perl)

    -   [How to add a user with limited visibility](How_to_add_a_user_with_limited_visibility)

    -   [How to monitor a Citrix XenServer Cluster](How_to_monitor_a_Citrix_XenServer_Cluster)

    -   [How to monitor a KVM installation](How_to_monitor_a_KVM_installation)

    -   [How to Monitor a Server with Enhanced IPMI sensor](How_to_Monitor_a_Server_with_Enhanced_IPMI_sensor)

    -   [How to monitor a XEN installation](How_to_monitor_a_XEN_installation)

    -   [How to monitor Microsoft Exchange](How_to_monitor_Microsoft_Exchange)

    -   [How to monitor Microsoft Hyper-V](How_to_monitor_Microsoft_Hyper-V)

    -   [How to monitor Microsoft Windows Eventlog ID](How_to_monitor_Microsoft_Windows_Eventlog_ID)

    -   [How to monitor MongoDB servers using contributed Management Pack](How_to_monitor_MongoDB_servers_using_contributed_Management_Pack)

    -   [How to Monitor Redhat Enterprise Linux Server (RHEL)](How_to_Monitor_Redhat_Enterprise_Linux_Server_RHEL_)
    ...
    -   [How to succeed with wireless monitoring](How_to_succeed_with_wireless_monitoring)
    ...
    -   [Include PNP graphs in a NagVis map and in a Widget in the Tactical Overview](Include_PNP_graphs_in_a_NagVis_map_and_in_a_Widget_in_the_Tactical_Overview)

    -   [Installing Bischeck](Installing_Bischeck)

    -   [Installing NRPE from EPEL](Installing_NRPE_from_EPEL)
    ...
    -   [Monitoring Dell servers](Monitoring_Dell_servers)

    -   [Monitoring HP/Compaq servers](Monitoring_HP_Compaq_servers)

    -   [Monitoring HP printers](Monitoring_HP_printers)

    -   [Monitoring log filters in Monitor 7.0 or higher](Monitoring_log_filters_in_Monitor_7.0_or_higher)

    -   [Monitoring Microsoft Active Directory](Monitoring_Microsoft_Active_Directory)

    -   [Monitoring Microsoft SQL-Server](Monitoring_Microsoft_SQL-Server)

    -   [Monitoring response-time via NSClient++](Monitoring_response-time_via_NSClient++)
    ...
    -   [Monitoring websites with webinject](Monitoring_websites_with_webinject)

    -   [Monitoring Zimbra MailServer](Monitoring_Zimbra_MailServer)

    -   [Monitor to Logserver Integration](Monitor_to_Logserver_Integration)
    ...
    -   [Tuning thresholds / amount of notifications](Tuning_thresholds_amount_of_notifications)

    -   [op5 Monitor integration towards BMC Proactive Net Performance Management (BPPM) using BMC Impact Poster (msend)](op5_Monitor_integration_towards_BMC_Proactive_Net_Performance_Management_BPPM_using_BMC_Impact_Poster_msend_)

    -   [OS-independent hardware monitoring for Dell hardware](OS-independent_hardware_monitoring_for_Dell_hardware)

    -   [OS-independent hardware monitoring for HP blade-enclosures](OS-independent_hardware_monitoring_for_HP_blade-enclosures)

    -   [Reverting a ramdisk enabled setup back to the default non-ramdisk layout](Reverting_a_ramdisk_enabled_setup_back_to_the_default_non-ramdisk_layout)

    -   [Running plugins with NRPE as root or another user](Running_plugins_with_NRPE_as_root_or_another_user)

    -   [Security hardening your Monitor installation](Security_hardening_your_Monitor_installation)

    -   [Sending outgoing email messages (notifications) through an SMTP relay server](Sending_outgoing_email_messages_notifications_through_an_SMTP_relay_server)
    ...
    -   [Using Custom Scripts In Statistics](Using_Custom_Scripts_In_Statistics)

    -   [Using eventhandlers to restart services](Using_eventhandlers_to_restart_services)
    ...
    -   [Instant support ticket creation from Logger using listview columns](Instant_support_ticket_creation_from_Logger_using_listview_columns)

    -   [Troubleshooting articles](Troubleshooting_articles)
        -   [Troubleshooting trapper](Troubleshooting_trapper)

    -   [Setting up Selenium Server on Microsoft Windows](Setting_up_Selenium_Server_on_Microsoft_Windows)
    ...
    -   [Monitoring Linux/Unix servers via SNMP](Monitoring_Linux_Unix_servers_via_SNMP)

    -   [Getting started](Getting_started)

    -   [Creating an HTTP API driven command-line tool](Creating_an_HTTP_API_driven_command-line_tool)

    -   [op5 Monitor Azure, change root password](op5_Monitor_Azure_change_root_password)

    -   [Delayed notifications](Delayed_notifications)

    -   [Synchronize and reinsert report data](Synchronize_and_reinsert_report_data)
    ...
    -   [Install OP5 Monitor without network access on CentOS 6](Install_OP5_Monitor_without_network_access_on_CentOS_6)

    -   [Installation of NRPE agent on SLES](Installation_of_NRPE_agent_on_SLES)

    -   [Installation of NRPE agent on Debian and Ubuntu](Installation_of_NRPE_agent_on_Debian_and_Ubuntu)

    -   [How to reset the password for local users](How_to_reset_the_password_for_local_users)

    -   [Handling NSClient++ settings in the Windows Registry](Handling_NSClient++_settings_in_the_Windows_Registry)

    -   [Sync contact groups with LDAP](Sync_contact_groups_with_LDAP)

    -   [Certificate based TLSv1+ encryption with NSClient++](Certificate_based_TLSv1+_encryption_with_NSClient++)

    -   [Create a self-signed CA & client certificate with OpenSSL](Create_a_self-signed_CA_client_certificate_with_OpenSSL)

    -   [Howto use check\_by\_ssh](Howto_use_check_by_ssh)
    ...
    -   [Get access to OP5 Labs](Get_access_to_OP5_Labs)

    -   [Using PowerShell with OP5 API](Using_PowerShell_with_OP5_API)

    -   [Migrate Monitor 7 from EL6 to EL7](Migrate_Monitor_7_from_EL6_to_EL7)

    -   [Installation of NRPE agent on CentOS and RHEL](Installation_of_NRPE_agent_on_CentOS_and_RHEL)

    -   [How to one-way integrate OP5 with ServiceNow](How_to_one-way_integrate_OP5_with_ServiceNow)

    -   [Certificate based authentication between check\_nrpe and NSClient++](Certificate_based_authentication_between_check_nrpe_and_NSClient++)

    -   [What application created that file?](What_application_created_that_file_)

    -   [Monitoring high cpu processes on Windows](Monitoring_high_cpu_processes_on_Windows)

    -   [Best Practices for deploying OP5 Monitor](Best_Practices_for_deploying_OP5_Monitor)

    -   [Adding license](Adding_license)

    -   [SAML based authentication in Monitor on CentOS 7](SAML_based_authentication_in_Monitor_on_CentOS_7)
-   [Sending metrics to Grafana](Sending_metrics_to_Grafana)
